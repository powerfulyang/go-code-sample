...
func showLearningTests() {
	fmt.Println("🎓 学习导向测试指南")
	fmt.Println("📚 通过测试学习Go语言")
	fmt.Println(strings.Repeat("=", 60))
	fmt.Println()

	fmt.Println("🌟 什么是学习导向测试？")
	fmt.Println("   学习导向测试是专门设计用于教学的测试文件，")
	fmt.Println("   它们包含详细的解释、示例和最佳实践。")
	fmt.Println()

	fmt.Println("📖 可用的学习测试:")
	fmt.Println("   📁 01-basics/03-data-types/learning_test.go")
	fmt.Println("      🎯 学习Go的基础数据类型")
	fmt.Println("      🔍 探索类型转换、零值、常见陷阱")
	fmt.Println()
	fmt.Println("   📁 01-basics/05-functions/learning_test.go")
	fmt.Println("      🎯 掌握函数的各种特性")
	fmt.Println("      🔍 探索参数传递、高阶函数、递归")
	fmt.Println()
	fmt.Println("   📁 01-basics/09-error-handling/learning_test.go")
	fmt.Println("      🎯 理解Go的错误处理哲学")
	fmt.Println("      🔍 探索自定义错误、错误包装、最佳实践")
	fmt.Println()
	fmt.Println("   📁 02-advanced-features/01-interfaces/learning_test.go")
	fmt.Println("      🎯 深入理解接口设计")
	fmt.Println("      🔍 探索多态性、组合、标准库接口")
	fmt.Println()
	fmt.Println("   📁 02-advanced-features/02-concurrency/learning_test.go")
	fmt.Println("      🎯 掌握并发编程精髓")
	fmt.Println("      🔍 探索goroutines、channels、同步原语")
	fmt.Println()
	fmt.Println("   📁 02-advanced-features/03-generics/learning_test.go")
	fmt.Println("      🎯 掌握Go 1.18+泛型特性")
	fmt.Println("      🔍 探索类型参数、约束、泛型编程模式")
	fmt.Println()
	fmt.Println("   📁 02-advanced-features/04-reflection/learning_test.go")
	fmt.Println("      🎯 理解反射机制和应用")
	fmt.Println("      🔍 探索Type、Value、动态调用、性能考虑")
	fmt.Println()
	fmt.Println("   📁 04-practical-applications/01-web-development/learning_test.go")
	fmt.Println("      🎯 掌握Web开发基础")
	fmt.Println("      🔍 探索HTTP处理器、中间件、JSON API")
	fmt.Println()

	fmt.Println("🚀 如何使用学习测试:")
	fmt.Println("   1️⃣ 运行特定的学习测试:")
	fmt.Println("      go test -v ./01-basics/03-data-types/ -run TestLearn")
	fmt.Println()
	fmt.Println("   2️⃣ 查看详细的学习过程:")
	fmt.Println("      go test -v ./02-advanced-features/01-interfaces/ -run TestLearnInterfaceBasics")
	fmt.Println()
	fmt.Println("   3️⃣ 运行所有学习测试:")
	fmt.Println("      go test -v ./... -run TestLearn")
	fmt.Println()
	fmt.Println("   4️⃣ 运行学习基准测试:")
	fmt.Println("      go test -bench=BenchmarkLearn ./...")
	fmt.Println()

	fmt.Println("💡 学习建议:")
	fmt.Println("   📚 按顺序学习: 从基础数据类型开始")
	fmt.Println("   🔍 仔细阅读: 每个测试都有详细的解释")
	fmt.Println("   ✏️  动手修改: 尝试修改测试代码观察结果")
	fmt.Println("   🧪 实验验证: 通过测试验证你的理解")
	fmt.Println("   📖 查看源码: 阅读测试源码了解实现细节")
	fmt.Println()

	fmt.Println("🎯 学习路径推荐:")
	fmt.Println("   🌱 初学者:")
	fmt.Println("      → 数据类型 → 函数 → 错误处理")
	fmt.Println("   🚀 进阶者:")
	fmt.Println("      → 接口 → 并发编程 → 性能优化")
	fmt.Println()

	fmt.Println("🔥 快速开始:")
	fmt.Println("   go test -v ./01-basics/03-data-types/ -run TestLearnBasicTypes")
	fmt.Println()
	fmt.Println("💫 记住: 最好的学习方式就是动手实践！")
}
...
func showUsage() {
	...
	fmt.Println("   learn       - 🎓 学习测试指南 (通过测试学习)")
